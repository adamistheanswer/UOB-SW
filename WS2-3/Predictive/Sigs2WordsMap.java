...
public class Sigs2WordsMap {
  ...
  public static void main(String[] args) {
    ...
    MapDictionary dictionary = new MapDictionary("src/Predictive/words.txt");
  ...
  //  TERMINAL SPEED TEST
//
//  Adams-MacBook:src AdamMBA$ time java Sigs2WordsMap 43556 96753 88726 263333 78277 386 227 3278 2 3 4 5 6 7 8 9
//
//      43556 - [gekko, hello]
//      96753 - [world, yorke]
//      88726 - [turbo, turco]
...
//      9 - [w, x, y, z]
//
//  real	0m1.517s  <<<----  Elapsed real (wall clock) time used by the process, in seconds.
//  user	0m2.548s  <<<----  Total number of CPU-seconds that the process used directly (in user mode), in seconds.
//  sys	  0m0.432s           Total number of CPU-seconds used by the system on behalf of the process (in kernel mode), in seconds.
